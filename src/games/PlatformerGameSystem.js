...
export class PlatformerGameSystem extends BaseSystem {
   ...
   */
  _showEndPanel(title, message, textFill) {
  ...
  _makeTouchButton(icon, x, y, size, code) {
